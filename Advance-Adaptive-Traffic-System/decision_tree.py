...
# Define and train the Decision Tree Regressor models for EW and NS directions
model_p_ew = DecisionTreeRegressor(random_state=42)
model_p_ns = DecisionTreeRegressor(random_state=42)
model_u_ew = DecisionTreeRegressor(random_state=42)
model_u_ns = DecisionTreeRegressor(random_state=42)
