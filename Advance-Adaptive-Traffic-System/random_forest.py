...
# Define and train the Random Forest Regressor models for EW and NS directions
model_p_ew = RandomForestRegressor(n_estimators=100, random_state=42)
model_p_ns = RandomForestRegressor(n_estimators=100, random_state=42)
model_u_ew = RandomForestRegressor(n_estimators=100, random_state=42)
model_u_ns = RandomForestRegressor(n_estimators=100, random_state=42)
...
# Calculate the ew green time and ns green time based on the conditions
